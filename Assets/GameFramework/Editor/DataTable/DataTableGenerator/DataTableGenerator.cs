...
using UnityEngine;
using GameFramework.EditorTools;
using System.Linq;
namespace GameFramework.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        {
            dataTableProcessor.SetCodeTemplate(ConstEditor.DataTableExcelPath, Encoding.UTF8);
            ...
            {
                Debug.LogError(Utility.Text.Format("生成{0}数据表结构代码失败:{1}", dataTableName, csharpCodeFileName));
            }
        }
